...
import { sampleWithRequiredData } from '../student-app.test-samples';
import { StudentAppService } from '../service/student-app.service';

import { StudentAppComponent } from './student-app.component';
import SpyInstance = jest.SpyInstance;

describe('StudentApp Management Component', () => {
  let comp: StudentAppComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StudentAppComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('should forward to studentService', () => {
      ...
      jest.spyOn(service, 'getStudentAppIdentifier');
      const id = comp.trackId(entity);
      expect(service.getStudentAppIdentifier).toHaveBeenCalledWith(entity);
